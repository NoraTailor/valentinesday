var ys = document.getElementById('yes');
...
if (no) {
	no.addEventListener('click', saidNo);
}
...
function saidYes() {
	...
	body.style.backgroundImage =
		'url(background-2062206_1280.jpg)';
}
...
ScrollTrigger.create({
	...
	onUpdate: function (self) {
		self.direction === -1
			? loop.timeScale(-1)
			: loop.timeScale(1); // onUpdate of the ST toggling direction of tween via changing its timeScale depending on direction of scroll
	},
});
